    ...
    >
      <div className="container">
        <div className="about">
          ...
          <p>
            <span>Email:</span>muhammadmaaz07@gmail.com
          </p>
          <p>
            <span>Phone:</span>03417012094
          </p>
        </div>
      ...
      <div className="container">
        <div className="logo">Lazzy <span>Code</span></div>
        <div className="links">
          ...
          <Link to={"https://www.youtube.com/@LazzyCode"} target="_blank">
            <AiFillYoutube />
          </Link>
          <Link to={"/"} target="_blank">
            <AiFillLinkedin />
